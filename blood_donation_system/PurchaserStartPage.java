...
public class PurchaserStartPage extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
      String user = jTextFieldUsername.getText(); // Assuming jTextFieldUsername is the field where user enters their username
    
    // Create an instance of Purchaser_account with the user parameter
    Purchaser_account purchaserAccount = new Purchaser_account(user);
    purchaserAccount.setVisible(true);;
    ...
    private static class jTextFieldUsername {
